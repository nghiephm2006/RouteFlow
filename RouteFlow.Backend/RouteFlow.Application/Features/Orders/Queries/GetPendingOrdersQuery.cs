...
namespace RouteFlow.Application.Features.Orders.Queries
{
    ...
    public class GetPendingOrdersQueryHandler : IRequestHandler<GetPendingOrdersQuery, IEnumerable<OrderDto>>
    {
        private readonly IOrderRepository _repository;

        public GetPendingOrdersQueryHandler(IOrderRepository repository)
        {
